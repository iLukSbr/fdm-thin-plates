...
set output "graf-mom-flet-x.png"
set nokey
dados="Momento Fletor X.txt"
set zrange [:] reverse
...
set title "{/:Bold {/=120 Momento Fletor da Placa na Direção X}}"
set xlabel "{/:Bold Eixo X [m]}" rotate by -8 offset 0,-1
set ylabel "{/:Bold Eixo Y [m]}" rotate by 12 offset 3,-1
set zlabel "{/:Bold Mx [kN.m]}" rotate by 90 offset -1,0
set xtics 1
set mxtics 2
set ytics 1
set mytics 2
